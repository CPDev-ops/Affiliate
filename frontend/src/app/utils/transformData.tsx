...
export const getTextByLevel = (level: LevelDto): string => {
    switch (level) {
        case 0:
            return 'text-[#45087B]'
        case 1:
...
export const getBackgroundButtonSummary = (level: LevelDto): string => {
    switch (level) {
        case 0:
            return 'bg-[#45087B]'
        case 1:
...
export const getTextModalFormByLevel = (level: LevelDto): string => {
    switch (level) {
        case 0:
            return 'text-[#540864]'
        case 1:
...
export const getBackgroundButtonModalForm = (level: LevelDto, domain: string): string => {
    if (level === 0) {
        switch (domain.toLowerCase()) {
            case 'pilar':
                return 'bg-[#FB2B54]';//color pilar
            case 'zarate':
                return 'bg-[#FF0000]';//color zarate
            case 'salta':
                return 'bg-[#540864]';//color salta
        }
    }
    switch (level) {
        case 1:
...
export const getBorderByLevel = (level: LevelDto): string => {
    switch (level) {
        case 0:
...
//bacgrkound
export const getColorIcon = (level: LevelDto): string => {
    switch (level) {
        case 0:
            return 'text-[#06DE0E]'
        case 1:
...
export const getColorMoneyText = (level: LevelDto): string => {
    switch (level) {
        case 0:
            return 'text-[#3840F7]'
        case 1:
...
export const getTextSummaryLevel = (level: LevelDto): string => {
    switch (level) {
        case 0:
...
export const getColorByChartText = (level: LevelDto): string => {
    switch (level) {
        case 0:
            return 'black';
        case 1:
...
export const getColorLinesChartBackground = (level: LevelDto): string => {
    switch (level) {
        case 0:
...
export const getColorLineMain = (level: LevelDto): string => {
    switch (level) {
        case 0:
...
export const getBackgroundButton = (level: LevelDto): string => {
    switch (level) {
        case 0:
...
export const getBackgroundButtonModal = (level: LevelDto): string => {
    switch (level) {
        case 0:
