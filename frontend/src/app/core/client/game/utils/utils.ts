...
export function getGradient(level: number | null): string {
    switch (level) {
        case 0:
...
export function getGradientGoals(level: number | null): string {
    switch (level) {
        case 0:
            return 'bg-gray-500  ';
        case 1:
...
export function getFirstColor(level: number | null): string {
    switch (level) {
        case 0:
...
export function getSecondColor(level: number | null): string {
    switch (level) {
        case 0:
